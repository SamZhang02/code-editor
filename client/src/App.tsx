...
const App = () => {
  ...
  return (
    <div className='flex h-screen w-screen flex-col items-center bg-zinc-900 p-32 text-zinc-100'>
      <div className='flex h-full w-[70rem] flex-col gap-8'>
        ...
        <div className='flex max-h-[95%] flex-1 rounded-2xl border border-zinc-400 p-1'>
          <div className='w-3/5'>
            <Editor
          ...
          <div
            className='flex h-full max-h-full w-2/5 overflow-auto p-4'
